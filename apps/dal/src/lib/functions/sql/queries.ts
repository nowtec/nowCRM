...
export const SQL = {
	...
	REACTIVATE_SUBSCRIPTIONS: `
      ...
      SET
        ...
        published_at = NOW()
      FROM subscriptions_contact_links scl
      JOIN subscriptions_channel_links schl
  ...
  ` as const,
    ...
    INSERT INTO events_contact_links (event_id, contact_id)
    VALUES ($1, $2)
  ` as const,

	LINK_EVENT_TO_CHANNEL: `
    INSERT INTO events_channel_links (event_id, channel_id)
    VALUES ($1, $2)
  ` as const,
